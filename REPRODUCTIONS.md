...
| **Depth Pro** | ℹ️ δ₁ **0.9347** _(paper does not evaluate NYU — earlier 0.961 pin was fabricated)_ | ℹ️ Sintel δ₁ **0.2409** / **0.400** _(blocked)_ · ℹ️ Middlebury δ₁ **0.7589** / **0.605** _(blocked, reads better)_ | ✅ Booster δ₁ **0.4878** vs **0.466** _(Table 1, 2026-05-31)_ | — | — | — | ℹ️ iBims δ₁ **0.8458** _(informational)_ |
