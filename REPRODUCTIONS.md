...
| `moge-vitl-diode-indoor` | MoGe-1 ViT-L on DIODE val-indoor | `abs_rel` | 0.0313 | **0.0465** | ±20% | RTX 3090 Ti, 2026-04-19, 325 indoor samples, **ROE alignment**. δ₁=0.9505. Paper is combined val (325+446=771 samples); indoor-only still ~49% over paper. Plain `scale_shift` baseline was 0.0584 → ROE closed 20%. Residual gap likely indoor-harder-than-outdoor (the combined-val paper number benefits from 446 easier outdoor samples). |
