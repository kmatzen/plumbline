...
| `moge-vitl-nyuv2` | MoGe-1 ViT-L on NYUv2 Eigen (Table 3) | `abs_rel` | 0.0297 | **0.0305** | ±10% | ✅ **MATCH under ROE** (RTX 3090 Ti, 2026-04-19). δ₁ 0.9826. Plain LSQ scale_shift was 0.0342 (15% gap); switching to `scale_shift_robust` (plumbline's IRLS+Huber implementation of MoGe's ROE protocol) closes to 2.7% of paper. |
