...
| **Depth Pro** | ℹ️ δ₁ **0.9347** _(no NYU row in paper)_ | — | ⌛ ETH3D δ₁ **0.415** _(Table 1 — official depth staging; [handoff](docs/ETH3D_DEPTH_PRO_TABLE1_HANDOFF.md))_ | ✅ Booster **0.4878** / **0.466** _(Table 1 match)_ | — | — | ℹ️ iBims **0.8458** _(info)_ · Table 1 off-paper: Sintel **0.2409**/0.400 · Midd **0.7589**/0.605 · Sun-RGBD **0.4505**/0.890 · NuScenes **0.5935**/0.491 ([eval doc](docs/DEPTH_PRO_TABLE1_METRIC_EVAL.md)) |
