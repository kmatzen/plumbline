...
| **CUT3R** _(video + unordered)_ | ℹ️ **0.0522** vs 0.086 _(better — D24 protocol delta: strict raw+crop vs lineage filled+no-crop. **Paper DOES reproduce**: CUT3R's own pipeline on its exact prepared set = **0.08595 ✓ (0.06 %)** — see "Paper-trust verifications" below. plumbline's standard-loader number is the documented delta, not a repro failure.)_ | ℹ️ **0.0858** vs 0.092 _(better — D24 protocol delta: Eigen-652+Garg vs lineage val_selection. **Paper reproduces: 0.09219 ✓ (0.2 %)** on CUT3R's own pipeline — see "Paper-trust verifications" below.)_ | — | — | — | ℹ️ recurrent/online — handles ordered video & unordered sets | — |
...
not a paper-match. **The exact set DOES reproduce**: CUT3R's own video
eval on the 5-seq × 110-frame set = **0.07661 ✓ (1.8 % off)** — see
"Paper-trust verifications" below. MonST3R also reports Bonn (0.067 w/ flow GA); a
