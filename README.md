...
**Status:** v0.2 in development. **42 paper-match cells** — 35 mono-depth
...
- **42 paper-match reproductions** with `source_confidence: verified_pdf`
