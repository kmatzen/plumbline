...
**Status:** v0.2 in development. **44 paper-match cells** — 37 mono-depth
...
- **44 paper-match reproductions** with `source_confidence: verified_pdf`
