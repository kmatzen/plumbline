...
**Status:** v0.2 in development. **45 paper-match cells** — 38 mono-depth
...
- **45 paper-match reproductions** with `source_confidence: verified_pdf`
