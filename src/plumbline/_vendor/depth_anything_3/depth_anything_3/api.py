...
# NOTE (plumbline vendor): top-level `from ...utils.export import export` made
# lazy — the export tree (gsplat/colmap/trimesh/moviepy) is pruned from the
# vendored depth subset. `export(...)` is imported on demand inside the
# export branches of inference(); the mono-depth path never calls it.
...
def export(*args, **kwargs):  # plumbline vendor: lazy shim for pruned export tree
    from depth_anything_3.utils.export import export as _export  # noqa: PLC0415
