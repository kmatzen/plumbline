...
| Depth Pro (Bochkovskii 2024, arXiv:2410.02073) | **1** | Partial | ✅ Booster δ₁ **0.4878** vs **0.466** (2026-05-31). ⚠️ Middlebury/NuScenes/Sun-RGBD off-paper (reads better on Midd/NuSc, worse on Sun-RGBD). Sintel δ₁ **0.2409** vs **0.400** (reads worse). Remaining: ETH3D metric GT. |
