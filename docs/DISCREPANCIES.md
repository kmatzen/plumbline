...
| Depth Pro (Bochkovskii 2024, arXiv:2410.02073) | **1** | Partial | ✅ Booster δ₁ **0.4878** vs **0.466** (2026-05-31, within tol). Sintel δ₁ **0.2409** vs **0.400** still off-paper under Table 16 protocol. NYU/KITTI not in paper; fabricated 0.961 pin removed 2026-04-20. Remaining Table 1: ETH3D/Middlebury/NuScenes/Sun-RGBD. |
