...
| Depth Pro (Bochkovskii 2024, arXiv:2410.02073) | **1** | Partial | ✅ Booster δ₁ **0.4878** vs **0.466** (2026-05-31). ⚠️ Middlebury δ₁ **0.7589** vs **0.605** (reads better, MiddEval3 F). Sintel δ₁ **0.2409** vs **0.400** off-paper. Remaining: ETH3D/NuScenes/Sun-RGBD. |
