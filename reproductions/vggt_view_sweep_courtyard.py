...
VGGT at max_views in {2, 4, 8}. Reports both:

- Absolute per-view errors (rotation / translation-direction) aggregated
  across samples — useful sanity on the world-frame alignment.
- Pairwise relative-pose AUC — the metric VGGT / MASt3R / DUSt3R
  papers report, directly comparable to published tables.
"""
...
def main() -> None:
    ...
    for i, sample in enumerate(samples):
        for n in VIEW_COUNTS:
            ...
            # Absolute per-view (skip the origin view).
            ...
            # Pairwise relative pose across all (i, j), i < j.
            if n >= 2:
    ...
    print("Device: cuda:0 (RTX 3090), dtype=bfloat16\n")
    print(
